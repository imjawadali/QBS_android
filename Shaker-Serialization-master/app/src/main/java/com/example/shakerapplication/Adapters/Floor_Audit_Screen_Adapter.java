...
import com.example.shakerapplication.Screens.FloorAuditScreen;

import java.util.ArrayList;
import java.util.List;

public class Floor_Audit_Screen_Adapter extends  RecyclerView.Adapter<Floor_Audit_Screen_Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Floor_Audit_Screen_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.goods_issue_screen_card,parent,false);
        return new Floor_Audit_Screen_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Floor_Audit_Screen_Adapter.ViewHolder holder, int position) {
...
//        description,
    ...
    public void setOnItemClickListener(Floor_Audit_Screen_Adapter.OnItemClickListener listener) {
        mListener = listener;
    }
